...
from pipeline_common import ALL_VARIANTS, LLMCache, load_json, save_json, topic_dir, variant_dir
...
def run_variant(name: str, cache: LLMCache, force: bool, tau: float, max_pairs: int) -> None:
...
def main() -> int:
    ...
    for name in args.variants:
        run_variant(name, cache, args.force, args.tau, args.max_pairs)
    return 0
